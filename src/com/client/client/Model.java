...
public class Model extends Animable {
	...
	static int camera_vertex_z[] = new int[MAX_POLYGON];// jesus fucking christ
														// why are all these
														// 65535? 65k?> l0l no
														// wonder mem usage went
														// up through the roof
														// jesus
	...
	public Model(int modelId) {
		...
		int[] priorityFix = new int[] { 33103, 33111, 33102, 33114, 29249, 29254, 29250, 29255, 29252, 29253, 60146,
				60148, 34149, 14395, 14424, 14421 , 31227};
		...
		if (newmodel[modelId]) {
			...
			if (!(modelId == 19176 || modelId == 19192 || modelId == 19174 || modelId == 19190 || modelId == 19178
					|| modelId == 19194 || modelId == 19183 || modelId == 19199 || modelId == 19172 || modelId == 19188
					|| modelId == 19180 || modelId == 19196)) {
				recolour(0, 255);
			}
	 ...
	 * 
	 * int i1 = ai.length; if (i == 0) { int j1 = 0; anInt1681 = 0; anInt1682 =
	 * 0; anInt1683 = 0; for (int k2 = 0; k2 < i1; k2++) { int l3 = ai[k2]; if
	 * (l3 < vertexSkin.length) { int ai5[] = vertexSkin[l3]; for (int i5 = 0;
	 * i5 < ai5.length; i5++) { int j6 = ai5[i5]; anInt1681 +=
	 * verticesXCoordinate[j6]; anInt1682 += verticesYCoordinate[j6]; anInt1683
	 * += verticesZCoordinate[j6]; j1++; }
	 * 
	 * } }
	 * 
	 * if (j1 > 0) { anInt1681 = anInt1681 / j1 + j; anInt1682 = anInt1682 / j1
	 * + k; anInt1683 = anInt1683 / j1 + l; return; } else { anInt1681 = j;
	 * anInt1682 = k; anInt1683 = l; return; } } if (i == 1) { for (int k1 = 0;
	 * k1 < i1; k1++) { int l2 = ai[k1]; if (l2 < vertexSkin.length) { int ai1[]
	 * = vertexSkin[l2]; for (int i4 = 0; i4 < ai1.length; i4++) { int j5 =
	 * ai1[i4]; verticesXCoordinate[j5] += j; verticesYCoordinate[j5] += k;
	 * verticesZCoordinate[j5] += l; }
	 * 
	 * } }
	 * 
	 * return; } if (i == 2) { for (int l1 = 0; l1 < i1; l1++) { int i3 =
	 * ai[l1]; if (i3 < vertexSkin.length) { int ai2[] = vertexSkin[i3]; for
	 * (int j4 = 0; j4 < ai2.length; j4++) { int k5 = ai2[j4];
	 * verticesXCoordinate[k5] -= anInt1681; verticesYCoordinate[k5] -=
	 * anInt1682; verticesZCoordinate[k5] -= anInt1683; int k6 = (j & 0xff) * 8;
	 * int l6 = (k & 0xff) * 8; int i7 = (l & 0xff) * 8; if (i7 != 0) { int j7 =
	 * SINE[i7]; int i8 = COSINE[i7]; int l8 = verticesYCoordinate[k5] * j7 +
	 * verticesXCoordinate[k5] * i8 >> 16; verticesYCoordinate[k5] =
	 * verticesYCoordinate[k5] * i8 - verticesXCoordinate[k5] * j7 >> 16;
	 * verticesXCoordinate[k5] = l8; } if (k6 != 0) { int k7 = SINE[k6]; int j8
	 * = COSINE[k6]; int i9 = verticesYCoordinate[k5] * j8 -
	 * verticesZCoordinate[k5] * k7 >> 16; verticesZCoordinate[k5] =
	 * verticesYCoordinate[k5] * k7 + verticesZCoordinate[k5] * j8 >> 16;
	 * verticesYCoordinate[k5] = i9; } if (l6 != 0) { int l7 = SINE[l6]; int k8
	 * = COSINE[l6]; int j9 = verticesZCoordinate[k5] * l7 +
	 * verticesXCoordinate[k5] * k8 >> 16; verticesZCoordinate[k5] =
	 * verticesZCoordinate[k5] * k8 - verticesXCoordinate[k5] * l7 >> 16;
	 * verticesXCoordinate[k5] = j9; } verticesXCoordinate[k5] += anInt1681;
	 * verticesYCoordinate[k5] += anInt1682; verticesZCoordinate[k5] +=
	 * anInt1683; }
	 * 
	 * } } return; } if (i == 3) { for (int i2 = 0; i2 < i1; i2++) { int j3 =
	 * ai[i2]; if (j3 < vertexSkin.length) { int ai3[] = vertexSkin[j3]; for
	 * (int k4 = 0; k4 < ai3.length; k4++) { int l5 = ai3[k4];
	 * verticesXCoordinate[l5] -= anInt1681; verticesYCoordinate[l5] -=
	 * anInt1682; verticesZCoordinate[l5] -= anInt1683; verticesXCoordinate[l5]
	 * = (verticesXCoordinate[l5] * j) / 128; verticesYCoordinate[l5] =
	 * (verticesYCoordinate[l5] * k) / 128; verticesZCoordinate[l5] =
	 * (verticesZCoordinate[l5] * l) / 128; verticesXCoordinate[l5] +=
	 * anInt1681; verticesYCoordinate[l5] += anInt1682; verticesZCoordinate[l5]
	 * += anInt1683; } } } return; } if (i == 5 && triangleSkin != null &&
	 * face_alpha != null) { for (int j2 = 0; j2 < i1; j2++) { int k3 = ai[j2];
	 * if (k3 < triangleSkin.length) { int ai4[] = triangleSkin[k3]; for (int l4
	 * = 0; l4 < ai4.length; l4++) { int i6 = ai4[l4]; (face_alpha)[i6] += j *
	 * 8; if ((face_alpha)[i6] < 0) (face_alpha)[i6] = 0; if ((face_alpha)[i6] >
	 * 255) (face_alpha)[i6] = 255; } } } } }
	 */
	private void method472(int animationType, int skin[], int xOffset, int yOffset, int zOffset) {
		...
		/*
		 * if (animationType == 2) { for (int l1 = 0; l1 < i1; l1++) { int i3 =
		 * skin[l1]; if (i3 < vertexSkin.length) { int ai2[] = vertexSkin[i3];
		 * for (int j4 = 0; j4 < ai2.length; j4++) { int k5 = ai2[j4];
		 * verticesXCoordinate[k5] -= xAnimOffset; verticesYCoordinate[k5] -=
		 * yAnimOffset; verticesZCoordinate[k5] -= zAnimOffset;
		 * 
		 * double x_ = xOffset - Math.floor(xOffset); double y_ = yOffset -
		 * Math.floor(yOffset); double z_ = zOffset - Math.floor(zOffset);
		 * xOffset = (int) xOffset & 0xff; yOffset = (int) yOffset & 0xff;
		 * zOffset = (int) zOffset & 0xff; xOffset += x_; yOffset += y_; zOffset
		 * += z_; int k6 = (int)((xOffset) * 8); int l6 = (int)((yOffset) * 8);
		 * int i7 = (int)((zOffset) * 8); if (i7 != 0) { int j7 = SINE[i7]; int
		 * i8 = COSINE[i7]; int l8 = verticesYCoordinate[k5] * j7 +
		 * verticesXCoordinate[k5] * i8 >> 16; verticesYCoordinate[k5] =
		 * verticesYCoordinate[k5] * i8 - verticesXCoordinate[k5] * j7 >> 16;
		 * verticesXCoordinate[k5] = l8; } if (k6 != 0) { int k7 = SINE[k6]; int
		 * j8 = COSINE[k6]; int i9 = verticesYCoordinate[k5] * j8 -
		 * verticesZCoordinate[k5] * k7 >> 16; verticesZCoordinate[k5] =
		 * verticesYCoordinate[k5] * k7 + verticesZCoordinate[k5] * j8 >> 16;
		 * verticesYCoordinate[k5] = i9; } if (l6 != 0) { int l7 = SINE[l6]; int
		 * k8 = COSINE[l6]; int j9 = verticesZCoordinate[k5] * l7 +
		 * verticesXCoordinate[k5] * k8 >> 16; verticesZCoordinate[k5] =
		 * verticesZCoordinate[k5] * k8 - verticesXCoordinate[k5] * l7 >> 16;
		 * verticesXCoordinate[k5] = j9; } verticesXCoordinate[k5] +=
		 * xAnimOffset; verticesYCoordinate[k5] += yAnimOffset;
	...
	public void convertTexturesTo317(int modelId, short[] textureIds, int[] texa, int[] texb, int[] texc,
		...
		int set = 0;
		int set2 = 0;
		boolean osrs = (modelId == 33144 || modelId == 33145 || modelId == 33103 || modelId == 33111 || modelId == 33102
				|| modelId == 33114);
			...
			if (l == 3) {
				...
				if (l7 == 0)
					...
					Rasterizer.drawTexturedTriangle(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1],
							...
							camera_vertex_z[k10], camera_vertex_z[k11], face_color[i], -1, -1, -1);
				} else if (l7 == 3) {
					...
					Rasterizer.drawTexturedTriangle(i7, j7, k7, j3, j4, j5, face_shade_a[i], face_shade_a[i],
							...
							camera_vertex_z[l10], camera_vertex_z[l11], face_color[i], -1, -1, -1);
				}
				if (l == 4) {
					if (j3 < 0 || j4 < 0 || j5 < 0 || j3 > DrawingArea.viewportRX || j4 > DrawingArea.viewportRX
					...
					if (i8 == 2) {
						...
						Rasterizer.drawTexturedTriangle(i7, j7, k7, j3, j4, j5, anIntArray1680[0], anIntArray1680[1],
								...
								camera_vertex_z[i11], camera_vertex_z[i12], face_color[i], -1, -1, -1);
					...
					if (i8 == 3) {
						...
						Rasterizer.drawTexturedTriangle(i7, j7, k7, j3, j4, j5, face_shade_a[i], face_shade_a[i],
								...
								camera_vertex_z[j11], camera_vertex_z[j12], face_color[i], -1, -1, -1);
						Rasterizer.drawTexturedTriangle(i7, k7, anIntArray1679[3], j3, j5, anIntArray1678[3],
