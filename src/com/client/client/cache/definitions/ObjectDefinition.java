...
public final class ObjectDefinition {
	...
	public static boolean debugOsrs = false;
	...
	public static ObjectDefinition forIDOSRS(int i) {
		...
		try {
			...
			boolean wallFixes = i == 1658 || i == 1625 || i == 1626 || i == 14508 || i == 14509 || i == 14510
					|| i == 14511;
			objectDef.aBoolean736 = true;

			if (wallFixes) {
				ObjectDefinition rug = ObjectDefinition.forID(1902);
				objectDef.mapSceneID = rug.mapSceneID;
			...
			if (debugOsrs) {
				objectDef.hasActions = true;
				objectDef.isUnwalkable = true;
				objectDef.name = "OSRS: " + i;
				objectDef.actions = new String[] { "" + i, null, null, null, null };
			}
	...
	private static boolean isOSRSObject(int objectId) {
		if (objectId >= 30283 && objectId <= 30379) {
			return true;
		}
	...
	private static final int[] OBJECTS_OSRS = {
			29241,
			// INFERNO
			30297, 30310, 14390, 14391, 30292, 30312, 30295, 30317, 30316, 30318, 30319, 30320, 30321, 30322, 30325,
			30326, 30327, 30311, 30312, 30313, 30314, 30315, 30294, 30323, 30324, 30325, 30326, 30327, 30328, 30329,
			30330, 30298, 30299, 30300, 30290, 30291, 30292, 30293, 30294, 30295, 30296, 30297, 30298, 30331, 30332,
			30333, 30334, 30335, 30336, 30337, 30338, 30339, 26947, 27787, 14393, 14392,

			// Custom home
			9731, 78, 77, 24009, 26181, 1764,
			// Resource area
			16490, 26760, 1761, 26300, 2097, 11726, 11735,
	...
	public static ObjectDefinition forID(int i) {
		...
		boolean wallFixes = i == 1658 || i == 1625 || i == 1626 || i == 14508 || i == 14509 || i == 14510 || i == 14511
				|| i == 4804 || i == 4806;
		...
		if (i == 1751) {// Oak
			ObjectDefinition wall = ObjectDefinition.forID(1281);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
			objectDef.name = wall.name;
			objectDef.modifiedModelColors = wall.modifiedModelColors;
			objectDef.originalModelColors = wall.originalModelColors;
			objectDef.actions = wall.actions;
			objectDef.mapSceneID = wall.mapSceneID;
			objectDef.sizeX = wall.sizeX;
			objectDef.sizeY = wall.sizeY;
		}
		if (i == 1760) {// Willow
			ObjectDefinition wall = ObjectDefinition.forID(1308);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
        ...
        if (i == 6189 || i == 26814 || i == 11666) {
        /*	objectDef.actions = new String[5];
        	objectDef.actions[0] = "Smelt";
        	objectDef.actions[1] = "Craft";*/
    	
				objectDef.hasActions = true;
				objectDef.actions = new String[] { "Smelt", "Craft", null, null, null };
			
        }
		if (i == 1758) {// Willow
			ObjectDefinition wall = ObjectDefinition.forID(5551);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		// REsource
		if (i == 7484) {// Copper
			ObjectDefinition wall = ObjectDefinition.forID(2090);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7485) {// Tin
			ObjectDefinition wall = ObjectDefinition.forID(2094);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7455) {// Iron
			ObjectDefinition wall = ObjectDefinition.forID(2092);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7489) {// Coal
			ObjectDefinition wall = ObjectDefinition.forID(2096);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7491) {// Gold
			ObjectDefinition wall = ObjectDefinition.forID(2098);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7459) {// Mithril
			ObjectDefinition wall = ObjectDefinition.forID(2103);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 7493) {// Addy
			ObjectDefinition wall = ObjectDefinition.forID(2105);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 1753) {// Yew
			ObjectDefinition wall = ObjectDefinition.forID(1309);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
			...
			objectDef.sizeX = wall.sizeX;
			objectDef.sizeY = wall.sizeY;
			objectDef.mapFunctionID = wall.mapFunctionID;
			objectDef.mapSceneID = wall.mapSceneID;
		}
		if (i == 1761) {// Yew
			ObjectDefinition wall = ObjectDefinition.forID(1306);
			objectDef.objectModelIDs = wall.objectModelIDs;
			objectDef.brightness = wall.brightness;
			objectDef.contrast = wall.contrast;
			objectDef.type = wall.type;
		...
		if (i == 4458) {
			objectDef.actions = new String[] { "Free-Supplies", "Buy-Sets", null, null, null };
			objectDef.name = "Welfare Table";
		}
		if (i == 28089) {
			objectDef.actions = new String[] { null, null, null, null, null };
			objectDef.name = null;
		 ...
		 * boolean debug = false;
		 * 
		 * if (debug) { objectDef.name = ""+i; objectDef.hasActions = true;
		 * objectDef.actions = new String[] {"lol" , null, null, null, null,
		 * null}; }
		 */
		return objectDef;
	}
	...
	public static void unpackConfig(CacheArchive streamLoader, CacheArchive secondArchive) {
		...
		// ObjectDefinition.stream.buffer);
