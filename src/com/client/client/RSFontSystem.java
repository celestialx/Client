		...
		for (int currentCharacter = 0; currentCharacter < string.length(); currentCharacter++) {
			...
			anInt4175 &= 0xff;
					...
					if (strikethroughColor != -1) {
						DrawingArea474.drawHorizontalLine(drawX, drawY + (int) (baseCharacterHeight * 0.69999999999999996D), lineWidth, strikethroughColor);
					}
					if (underlineColor != -1) {
		...
		for (int currentCharacter = 0; currentCharacter < string.length(); currentCharacter++) {
			...
			if (character == 60) {
				...
				anInt4175 &= 0xff;
					...
					if (strikethroughColor != -1) {
						DrawingArea474.drawHorizontalLine(drawX, drawY + (int) (baseCharacterHeight * 0.7), i_109_, strikethroughColor);
					}
					if (underlineColor != -1) {
