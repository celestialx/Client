...
public final class TextDrawingArea extends DrawingArea {
	...
	public void method389(boolean flag, int i, int j, String s, int k) {
			...
			if (c != ' ') {
				if (flag)
					method392(aByteArrayArray1491[c],
							i + anIntArray1494[c] + 1, k + anIntArray1495[c]
									+ 1, anIntArray1492[c], anIntArray1493[c],
							0);
		...
		if (aBoolean1499)
			DrawingArea.method339(k
					+ (int) (anInt1497 * 0.69999999999999996D),
					0x800000, i - l, l);
	}
	...
	public void drawRegularText(boolean flag1, int i, int j, String s, int k) {
		...
		if (aBoolean1499)
			DrawingArea.drawLine(k + (int) (anInt1497 * 0.69999999999999996D), 0x800000, i - l, l);
	}
