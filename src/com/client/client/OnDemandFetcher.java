...

{
	...
	public void updateMapIndex(int count) {
        try (FileOutputStream fos = new FileOutputStream("./map_index");
                DataOutputStream out = new DataOutputStream(fos)) {
            out.writeShort(count);
            for (int index = 0; index < count; index++) {
                out.writeShort(regionIds[index]);
                out.writeShort(landscapeIds[index]);
...
//			if(regionIds[i2] == 10537) {
//				System.out.println("Pest control: "+i2);
//			}
//			if(regionIds[i2] == 11150) {
//				System.out.println("Monkey skeletons: "+i2);
//			}
			for(int i : dntUse)//lol cant use
			{
		...
		/** KRAKEN **/
		regionIds[941] = 14681;
		landscapeIds[941] = 1960;
		objectMapIds[941] = 1961;

		regionIds[942] = 14682;
		landscapeIds[942] = 1870;
		objectMapIds[942] = 1871;

		regionIds[956] = 14937;
		landscapeIds[956] = 1962;
		objectMapIds[956] = 1963;

		regionIds[957] = 14938;
		landscapeIds[957] = 1872;
		objectMapIds[957] = 1873;

		regionIds[958] = 14939;
		landscapeIds[958] = 1864;
		objectMapIds[958] = 1865;

		regionIds[940] = 14680;
		landscapeIds[940] = 1954;
		objectMapIds[940] = 1955;

//		regionIds[955] = 14936;
//		landscapeIds[955] = 1874;
//		objectMapIds[955] = 1875;

		regionIds[971] = 15192;
		landscapeIds[971] = 1966;
		objectMapIds[971] = 1967;

		regionIds[972] = 15193;
		landscapeIds[972] = 1964;
		objectMapIds[972] = 1965;

		regionIds[941] = 14681; // indices1
		landscapeIds[941] = 1960; // indices2
...
//		regionIds[787] = 12961;
//		landscapeIds[787] = 1868;
//		objectMapIds[787] = 1869;
	...
	private final void handleFailed()
	{
		...
		while(extraFileCount < 10) 
		{
			...
			try {
				...
				closeRequest(OnDemandRequest_1);
				waiting = true;
			} catch(Exception e) { System.out.println("missing: type: "+OnDemandRequest_1.dataType+" ID"+OnDemandRequest_1.id);}
		}
	}
