...
public final class Player extends Entity {
	...
	public boolean discoItems(int itemId) {
		...
		return ((itemId == 5572) || (itemId == 5573) || (itemId == 640) || (itemId == 650) || (itemId == 1121) || (itemId == 544) || (itemId == 542)
				
				|| (itemId == 1165) || (itemId == 1283) || (itemId == 1125) || (itemId == 1077) || (itemId == 7332) || (itemId == 4125)
